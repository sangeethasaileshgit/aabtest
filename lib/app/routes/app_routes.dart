...
class AppRoutes extends RootStackRouter {
      ...
      AutoRoute(
        ...
        children: [
          ...
          ...[
            ...
            AutoRoute(
              path: 'facility-list',
              page: LandlordFacilityListRoute.page,
            ),

            // Manage Facility
            AutoRoute(
              path: 'manage-facility',
              page: LandlordManageFacilitiesRoute.page,
            ),
          ],
          ...
          ...[
            ...
            AutoRoute(
              path: 'amenity-list',
              page: LandlordAmenitiesListRoute.page,
            ),

            // Manage Amenity
            AutoRoute(
              path: 'manage-Amenity',
              page: LandlordManageAmenitiesRoute.page,
            ),
          ],
          //------------------Landlord Payments------------------//
  ...
  List<AutoRouteGuard> get guards {
    return [OverlayContextMiddleware(widgetRef)];
  }
}
