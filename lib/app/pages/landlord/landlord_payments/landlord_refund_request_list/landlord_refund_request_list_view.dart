                            ...
                            return DynamicListCard.keyValueBody(
                              ...
                              keyValues: [
                                ...{
                                  ...
                                  context.t.common.tenantName: item.tenant?.name ?? "N/A",
                                  context.t.common.propertyName: item.property?.stepTwoData?.adTitle ?? "N/A",
                                  context.t.common.propertyId: item.property?.puid ?? "N/A",
                                  context.t.common.depositAmount: item.deposit?.depositAmount?.quickCurrency() ?? "N/A",
                              ...
                              child: EmptyWidget(
                                ...
                                emptyBuilder: (context) {
                                  return RetryButtons.scrollView(
                                    ...
                                    context.t.exceptions.noStatusRefundReqFound.landlord(
                                      status: controller.selectedFilter.label(context).toLowerCase(),
                                    ),
              ...
              InvoiceActionBuilder<ElevatedButton>(
                builder: (invCtx) {
                  return ElevatedButton.icon(
                    onPressed: () async {
                      await InvoiceDetailsView.webViewController(invCtx)?.printCurrentPage();
                      return;
                    },
