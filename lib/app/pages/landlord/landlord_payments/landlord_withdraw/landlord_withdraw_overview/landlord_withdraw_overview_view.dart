...
class LandlordWithdrawOverviewView extends StatefulWidget {
  ...
  @override
  State<LandlordWithdrawOverviewView> createState() => _LandlordWithdrawOverviewViewState();
}

class _LandlordWithdrawOverviewViewState extends State<LandlordWithdrawOverviewView> {
  @override
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            context.t.common.currentBalance,
                            style: _theme.textTheme.bodyMedium?.copyWith(color: _theme.colorScheme.secondary),
                          ),
                        ],
                      ),
                    ),
              ...
              Row(
                ...
                children: [
                  ...
                  TextButton.icon(
                    ...
                    label: Text(
                      context.t.common.linkANewBankAccount,
                      ...
                      endActionPane: ActionPane(
                        ...
                        children: [
                          SlidableAction(
                            ...
                            backgroundColor: _theme.colorScheme.primary.withValues(alpha: 0.05),
      ...
      bottomNavigationBar: ScaffoldBottomNavWrapper(
        child: SizedBox(
          ...
          child: ElevatedButton(
            ...
            child: Text(context.t.common.payoutRequest),
          ),
