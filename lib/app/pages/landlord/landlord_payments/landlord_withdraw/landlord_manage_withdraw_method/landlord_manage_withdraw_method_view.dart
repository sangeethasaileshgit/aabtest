...
class LandlordManageWithdrawMethodView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<LandlordManageWithdrawMethodView> createState() => _LandlordManageWithdrawMethodViewState();
}

class _LandlordManageWithdrawMethodViewState extends ConsumerState<LandlordManageWithdrawMethodView> {
  @override
  void initState() {
    super.initState();
    ...
    if (widget.isEditing) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        ref.read(landlordManageWithdrawMethodViewNotifier).handleEditInit(widget.editModel!);
      });
    }
  }
        ...
        return Scaffold(
          appBar: CustomAppBar(
            title: Text(
              ...
              widget.isEditing ? context.t.common.editAccount : context.t.common.addNewAccount,
            ),
          ),
                ...
                children: [
                    ...
                    builder: (_) {
                      ...
                      return Skeletonizer(
                        ...
                        child: DropdownButtonFormField<AdminWithdrawMethod>(
                          ...
                          hint: Text(
                            context.t.form.anyDropdown.hint(label: context.t.common.withdrawMethod).sentenceCase,
                          ),
                          decoration: InputDecoration(
                            // labelText: 'Withdraw Method',
                            labelText: context.t.form.anyDropdown.label(label: "${context.t.common.withdrawMethod}*"),
                          ),
                          isExpanded: true,
                          menuMaxHeight: 250,
                          ...
                          onChanged: widget.isEditing ? null : controller.handleSelectPaymentMethod,
                          validator: (value) {
                            if (value == null || (value.id ?? 0) <= 0) {
                              // return "Please select a payment method.";

                              return context.t.form.anyDropdown.errors
                                  .required(label: context.t.common.withdrawMethod)
                                  .sentenceCase;
                            }
                            return null;
                          },
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      labelText: '${context.t.pages.offlinePayment.extra.accountNumber}*',
                      // hintText: 'Enter your account number',
                      hintText: context.t.form.anyField.hint(
                        label: context.t.pages.offlinePayment.extra.accountNumber,
                      ),
                    ),
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                        return context.t.common.pleaseEnterYourAccountNumber;
                      }
                      return null;
                    },
                  ),
  ...
  Future<void> _handleFormSubmit(BuildContext ctx) async {
    final _result = await showAsyncLoadingOverlay(
      ...
      asyncFunction: () => Future.microtask(
        () => ref.read(landlordManageWithdrawMethodViewNotifier).handleFormSubmit(widget.editModel?.id),
      ),
    );
