...
class LandlordWithdrawRequestView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<LandlordWithdrawRequestView> createState() => _LandlordWithdrawRequestViewState();
}

class _LandlordWithdrawRequestViewState extends ConsumerState<LandlordWithdrawRequestView> {
  @override
  void initState() {
    super.initState();
                ...
                children: [
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(
                              child: Builder(
                                builder: (_) {
                                  final _chargeAmount = controller.selectedPaymentMethod?.chargeType == "fixed"
                                      ? controller.selectedPaymentMethod?.charge?.quickCurrency()
                  ...
                  NumberFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: context.t.form.anyField.hint(label: context.t.common.withdrawAmount).sentenceCase,
                    ),
                    validator: (v) {
                    ...
                    data: (data) {
                      return ListView.separated(
                        ...
                        itemBuilder: (_, index) {
                          ...
                          final _isSelected = controller.selectedPaymentMethod == _method;
                          ...
                          return Slidable(
                                      ...
                                      children: [
                                        ...
                                        IconButton(
                                          ...
                                          onPressed: () async {
                                            ...
                                            return await Slidable.of(slideCtx)?.close();
                                          },
                                        ),
                                        IconButton(
                            ...
                            child: Material(
                              ...
                              child: ListTile(
                                ...
                                trailing: Icon(
                                  _isSelected ? Bootstrap.check_circle_fill : Bootstrap.arrow_up_right,
  ...
  Future<void> _handleFormSubmit(BuildContext ctx) async {
    ...
    if (ctx.mounted) {
      ...
      showCustomSnackBar(
        ctx,
        content: Text(_result.right?.message ?? context.t.common.requestSendSuccess),
  ...
  Future<void> _handleDeleteWithdrawMethod(BuildContext ctx, int id) async {
    ...
    if (context.mounted) {
      final _result = await showAsyncLoadingOverlay(
        ctx,
        asyncFunction: () => Future.microtask(
          () => ref.read(landlordWithdrawRepoProvider).deleteUserWithdrawMethod(id),
        ),
      );
