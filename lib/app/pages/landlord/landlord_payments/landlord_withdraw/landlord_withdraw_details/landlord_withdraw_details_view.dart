                    ...
                    child: EmptyWidget(
                      ...
                      emptyBuilder: (context) {
                        return RetryButtons.scrollView(
                          ...
                          summary.error ?? context.t.exceptions.transactionSummaryApiException,
                      ...
                      Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...{
                              // "Transaction ID":
                              context.t.common.transactionId: data?.uid ?? "N/A",
                              // "Transaction Type":
                              context.t.common.transactionType: data?.paymentType ?? "N/A",
                              // "Request Date":
                              context.t.common.requestDate:
                                  ...
                                  "N/A",
                              // "Amount":
                              context.t.common.amount: data?.withdraw?.amount?.quickCurrency() ?? "N/A",
                              // "Fee":
                              context.t.common.fee: data?.withdraw?.charge?.quickCurrency() ?? "N/A",
                              // "Payment Status":
                              context.t.common.paymentStatus: _status,
                              // "Generated Time"
                              context.t.common.generatedTime: DateTime.now().formatDate(
                                pattern: 'dd MMM yyyy - hh:mm:ss',
                              ),
                            }.entries.map((entry) {
                              ...
                              return KeyValueRow(
                                ...
                                titleFlex: _ckFlex,
                                description: _isStatus ? _description.label(context) : _description.toString(),
