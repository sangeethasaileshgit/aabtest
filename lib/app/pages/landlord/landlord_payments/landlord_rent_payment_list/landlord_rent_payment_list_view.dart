                            ...
                            return DynamicListCard.keyValueBody(
                              ...
                              keyValues: [
                                ...{
                                  ...
                                  context.t.common.tenantName: item.rent?.tenant?.name ?? "N/A",
                                  context.t.common.propertyName: item.rent?.property?.stepTwoData?.adTitle ?? "N/A",
                                  context.t.common.propertyId: item.rent?.property?.puid ?? "N/A",
                                  ...
                                  final _isAdminCharge = entry.key.contains('__admin_charge__');

                                  return KeyValueRow(
                                    title: entry.key.split('__admin_charge__').first,
                                    titleFlex: 4,
