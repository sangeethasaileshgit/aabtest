...
@RoutePage()
class LandlordApplicationListView extends ConsumerStatefulWidget {
  const LandlordApplicationListView({super.key, this.scaffoldKey});
  final GlobalKey<ScaffoldState>? scaffoldKey;

  @override
  ConsumerState<LandlordApplicationListView> createState() => _LandlordApplicationListViewState();
}

class _LandlordApplicationListViewState extends _$LandlordApplicationListViewState {
  @override
                            ...
                            emptyBuilder: (context) {
                              return RetryButtons.scrollView(
                                context.t.exceptions.noApplicationFoundHint.template(
                                  subject: context.t.exceptions.noApplicationFoundHint.subjects.landlord,
                                ),
...
abstract class _$LandlordApplicationListViewState extends ConsumerState<LandlordApplicationListView>
