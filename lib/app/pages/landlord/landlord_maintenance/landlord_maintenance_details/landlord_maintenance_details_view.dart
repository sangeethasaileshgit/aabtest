...
class LandlordMaintenanceDetailsView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<LandlordMaintenanceDetailsView> createState() => _LandlordMaintenanceDetailsViewState();
}

class _LandlordMaintenanceDetailsViewState extends ConsumerState<LandlordMaintenanceDetailsView> {
  @override
  void initState() {
    super.initState();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
              ...
              child: Column(
                ...
                children: [
                  ...
                  ...{
                    ...
                    // "Property Name":
                    context.t.common.propertyName: _data?.property?.stepTwoData?.adTitle ?? "N/A",
                    // "Property Address":
                    context.t.common.propertyAddress: PropertyCardData.buildAddress([
      ...
      bottomNavigationBar: ([MaintenanceStatus.completed, MaintenanceStatus.rejected].contains(status))
          ? null
                        ...
                        child: OutlinedButton(
                          onPressed: () async {
                            return await _handleReject(
                              context,
                              (note) => ref.read(maintenanceRepoProvider).rejectMaintenance(widget.id, note: note),
                            );
                          },
                    ...
                    Expanded(
                      child: SizedBox(
                        ...
                        child: ElevatedButton(
                          ...
                          child: Text(
                            switch (status) {
                              MaintenanceStatus.pending => MaintenanceStatus.processing.label(context),
                              MaintenanceStatus.processing => context.t.common.complete,
                              _ => '',
                            },
                          ),
                        ),
      ...
      builder: (popContext) {
        return DescriptionTakerDialog(
          ...
          fieldDecoration: InputDecoration(
            ...
            hintText: context.t.form.anyField.hint(label: context.t.common.comment).sentenceCase,
          ),
          validator: (value) {
            if (value == null || value.trim().isEmpty) {
              // return 'Write Comment';
              return context.t.form.anyField.errors.required(label: context.t.common.comment).sentenceCase;
            }
            return null;
          },
        );
