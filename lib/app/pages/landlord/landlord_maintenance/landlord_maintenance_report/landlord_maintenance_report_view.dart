...
class LandlordMaintenanceReportView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<LandlordMaintenanceReportView> createState() => _LandlordMaintenanceReportViewState();
}

class _LandlordMaintenanceReportViewState extends ConsumerState<LandlordMaintenanceReportView> {
              ...
              data: (d) {
                ...
                return Column(
                  ...
                  children: [
                    ...
                    Text.rich(
                      context.t.pages.landlordMaintenanceReport.totalMaintenanceCost(
                        amount: TextSpan(
                          text: _data?.allProperties?.maintenanceTotalCost?.quickCurrency(),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: OverviewContainer(
                              ...
                              label: context.t.pages.landlordMaintenanceReport.maintenancePending,
                              value: _data?.allProperties?.maintenancePending ?? 0,
                              isCurrency: false,
                          ...
                          Expanded(
                            child: OverviewContainer(
                              ...
                              label: context.t.pages.landlordMaintenanceReport.maintenanceProcessing,
                              value: _data?.allProperties?.maintenanceProcessing ?? 0,
                              isCurrency: false,
                        ...
                        children: [
                          ...
                          Expanded(
                            child: OverviewContainer(
                              ...
                              label: context.t.pages.landlordMaintenanceReport.maintenanceCompleted,
                              value: _data?.allProperties?.maintenanceCompleted ?? 0,
                              isCurrency: false,
                          ...
                          Expanded(
                            child: OverviewContainer(
                              label: context.t.pages.landlordMaintenanceReport.maintenanceRejected,
                              value: _data?.allProperties?.maintenanceRejected ?? 0,
                              isCurrency: false,
                    ...
                    ...[
                      ...
                      Builder(
                        builder: (_) {
                          if (_propertyList.hasError && !_propertyList.hasValue) {
                            return Text.rich(
                          ...
                          final _properties = [...?_propertyList.valueOrNull?.data?.data];
                          ...
                          return Skeletonizer(
                            ...
                            child: DropdownButtonFormField<int>(
                              ...
                              hint: Text(
                                context.t.form.anyDropdown.hint(label: context.t.common.property).sentenceCase,
                              ),
                              ...
                              items: List.generate(
                                ...
                                (index) {
                                  ...
                                  return DropdownMenuItem<int>(
                                    value: _property.id,
                                    child: Text(_property.stepTwoData?.adTitle ?? "N/A"),
                                  );
                                },
                              ),
                              menuMaxHeight: 250,
                      ...
                      Text.rich(
                        context.t.pages.landlordMaintenanceReport.totalMaintenanceCost(
                          amount: TextSpan(
                            text: _data?.individualProperty?.maintenanceTotalCost?.quickCurrency(),
                            style: _theme.textTheme.bodyMedium,
                          ),
                        ),
                        style: _theme.textTheme.titleLarge?.copyWith(
                        ...
                        children: [
                          ...
                          Expanded(
                            child: OverviewContainer(
                              // label: 'Maintenance Pending',
                              label: context.t.pages.landlordMaintenanceReport.maintenancePending,
                              value: _data?.individualProperty?.maintenancePending ?? 0,
                              isCurrency: false,
                              color: const Color(0xff2400FF).withValues(alpha: 0.10),
                            ),
                          ),
                          ...
                          Expanded(
                            child: OverviewContainer(
                              // label: 'Maintenance Processing',
                              label: context.t.pages.landlordMaintenanceReport.maintenanceProcessing,
                              value: _data?.individualProperty?.maintenanceProcessing ?? 0,
                              isCurrency: false,
                              color: const Color(0xffFF9900).withValues(alpha: 0.15),
                            ),
                          ),
                        ...
                        children: [
                          ...
                          Expanded(
                            child: OverviewContainer(
                              // label: 'Maintenance Completed',
                              label: context.t.pages.landlordMaintenanceReport.maintenanceCompleted,
                              value: _data?.individualProperty?.maintenanceCompleted ?? 0,
                              isCurrency: false,
                              color: Color(0xffD9F2E5),
                            ),
                          ),
                          ...
                          Expanded(
                            child: OverviewContainer(
                              ...
                              label: context.t.pages.landlordMaintenanceReport.maintenanceRejected,
                              value: _data?.individualProperty?.maintenanceRejected ?? 0,
                              isCurrency: false,
                              color: Color(0xffFFDFDF),
                            ),
                          ),
                  ...
                  child: GridView.count(
                    ...
                    children: List.generate(
                      ...
                      (index) => OverviewContainer(
                        label: context.t.common.maintenancePending,
                        value: 12,
                        isCurrency: false,
...
final maintenanceReportProvider = FutureProvider.autoDispose.family<MaintenanceReportModel, MaintenanceReportFilter>(
