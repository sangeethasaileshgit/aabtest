...
class LandlordBottomNavView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<LandlordBottomNavView> createState() => _LandlordBottomNavViewState();
}
          ...
          builder: (newContext) {
            ...
            return CustomNavigationDrawer(
              navigationTiles: [
                ...
                NavDrawerTileItem(
                  ...
                  submenu: [
                    ...
                    NavDrawerTileItem(
                      ...
                      route: const LandlordMaintenanceReportRoute(),
                    ),
                  ],
                ),
                // NavDrawerTileItem(
                ...
                //       route: const LandlordRentPaymentListRoute(),
                //     ),
                //     NavDrawerTileItem(
                //       // title: "Deposit & Utility Payment",
                //       title: context.t.common.depositUtilityPayment,
                //       route: const LandlordDepositUtilityPaymentListRoute(),
                //     ),
                //     NavDrawerTileItem(
                //       title: context.t.common.refundRequest,
                //       route: const LandlordRefundRequestListRoute(),
                //     ),
                //   ],
                // ),
                // NavDrawerTileItem(
                ...
                // ),
                NavDrawerTileItem(
                  title: context.t.common.facilities,
                  icon: DAppSvgIcons.sidebar.facility.path,
                  route: const LandlordFacilityListRoute(),
                ),
                NavDrawerTileItem(
                  title: context.t.common.amenities,
                  icon: DAppSvgIcons.sidebar.amenity.path,
                  route: const LandlordAmenitiesListRoute(),
                ),
              ...
              onTap: (tile) async {
                ...
                if (tile.tileType == NavDrawerTileType.menu && tile.route != null) {
      ...
      return await showDialog<void>(
        ...
        builder: (popContext) {
          return AlertDialog(
            ...
            title: Text(context.t.prompt.subscriptionModal.title),
            content: Text(context.t.prompt.subscriptionModal.message),
            actions: [
              TextButton(
                onPressed: () async {
                  Navigator.of(popContext).pop();
                  return context.router.push<void>(const SubscriptionListRoute()).whenComplete(() => setState(() {}));
                },
                child: Text(context.t.common.subscribe),
              ),
            ],
          );
        },
