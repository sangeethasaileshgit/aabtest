...
class LandlordManageLaborView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<LandlordManageLaborView> createState() => _LandlordManageLaborViewState();
}

class _LandlordManageLaborViewState extends ConsumerState<LandlordManageLaborView> {
  @override
  void initState() {
    if (widget.editModel != null) {
      ref
          .read(landlordManageLaborProvider)
          .handleInitEdit(
            widget.editModel!,
          );
    }
    ...
    return FormWrapper(
      builder: (formContext) {
        return Scaffold(
          appBar: CustomAppBar(
            title: Text(
              widget.editModel != null ? context.t.common.editLabor : context.t.common.addNewLabor,
            ),
          ),
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      if (value == null || value.trim().isEmpty) {
                        ...
                        return context.t.form.anyField.errors.required(label: context.t.common.fullName).sentenceCase;
                      }
                      return null;
                    },
                  ),
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      if (value == null || value.isEmpty) {
                        ...
                        return context.t.form.anyField.errors.required(label: context.t.common.email).sentenceCase;
                      }
                      if (!value.isEmail) {
