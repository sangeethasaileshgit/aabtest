...
class LandlordLaborDetailsView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<LandlordLaborDetailsView> createState() => _LandlordLaborDetailsViewState();
}

class _LandlordLaborDetailsViewState extends ConsumerState<LandlordLaborDetailsView> {
  @override
  void initState() {
    super.initState();
                ...
                return Column(
                  ...
                  children: [
                    ...
                    ...{
                      ...
                      // "Phone Number":
                      context.t.common.mobileNumber: data.phone?.buildPhone ?? 'N/A',
                      // "Labor Salary":
                      context.t.common.laborSalary: data.salary?.quickCurrency() ?? "N/A",
                      // "Gender":
                  ...
                  child: OutlinedButton(
                    onPressed: () async {
                      return await _handleDelete(
                        context,
                        () => ref.read(landlordLaborRepoProvider).deleteLabor(widget.id),
                      );
                    },
