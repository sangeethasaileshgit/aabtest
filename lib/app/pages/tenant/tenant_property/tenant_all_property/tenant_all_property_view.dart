...
class TenantAllPropertyView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TenantAllPropertyView> createState() => _TenantAllPropertyViewState();
}
      ...
      await showDynamicFilterModalSheet<PropertyFilters, dynamic>(
        ...
        filters: [
          ...
          FilterModalData<PropertyFilters, dynamic>.dropdown(
            ...
            labelText: context.t.form.anyDropdown.label(label: context.t.common.propertyType),
