...
class TenantManageRefundRequestView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TenantManageRefundRequestView> createState() => _TenantManageRefundRequestViewState();
}

class _TenantManageRefundRequestViewState extends ConsumerState<TenantManageRefundRequestView> {
  @override
                ...
                children: [
                    ...
                    builder: (_) {
                      if (_myRentResp.hasError && !_myRentResp.hasValue) {
                        return Text.rich(
                          RetryButtons.inlineText(
                            _myRentResp.error!,
                            onAction: () => ref.refresh(rentListProvider),
                          ),
                        );
                      }
                      ...
                      return Skeletonizer(
                        ...
                        child: DropdownButtonFormField<RentDetails>(
                          ...
                          isExpanded: true,
                          initialValue: controller.selectedRent,
                          items: List.generate(
                            _rents.length,
                            (index) {
                              ...
                              return DropdownMenuItem<RentDetails>(
                                value: _rent,
                                child: Text(_rent.property?.stepTwoData?.adTitle ?? "N/A"),
                              );
                            },
                          ),
                          menuMaxHeight: 250,
                          onChanged: (v) {
                            ...
                            controller.invoiceController.text = v?.securityDeposit?.invoiceNo ?? '';
                          },
                          validator: (value) {
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: context.t.form.anyField
                          .hint(label: context.t.common.selectPropertyToSeeInvoice)
                          .sentenceCase,
                    ),
                  ),
                  const SizedBox.square(dimension: 16),
                    ...
                    builder: (_) {
                      ...
                      return Skeletonizer(
                        ...
                        child: DropdownButtonFormField<int>(
                          ...
                          hint: Text(
                            context.t.form.anyDropdown.hint(label: context.t.common.refundReason).sentenceCase,
                          ),
                          isExpanded: true,
                          menuMaxHeight: 250,
                          decoration: InputDecoration(
                          ...
                          initialValue: controller.selectedReasonId,
                          items: List.generate(
                            _reasons.length,
                            (index) {
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: context.t.form.anyField.hint(label: context.t.common.bankName).sentenceCase,
                    ),
                    textInputAction: TextInputAction.next,
                    keyboardType: TextInputType.name,
                    autofillHints: [AutofillHints.name],
                    validator: (value) {
                      if (value == null || value.trim().isEmpty) {
                        ...
                        return context.t.form.anyField.errors.required(label: context.t.common.bankName).sentenceCase;
                      }
                      return null;
                    },
                  ),
                  ...
                  NumberFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: context.t.form.anyField.hint(label: context.t.common.bankAccNum).sentenceCase,
                    ),
                    ...
                    validator: (value) {
                      return NumberFormField.nonZeroRequired(
                        ...
                        emptyErrorText: context.t.form.anyField.errors
        ...
        builder: (popContext) {
          return PopScope(
            ...
            child: InfoDialog.info(
              ...
              description: context.t.exceptions.refundRequestHint.tenantReqSuccess,
              onPressed: () {
