...
class TenantMaintenanceDetailsView extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<TenantMaintenanceDetailsView> createState() => _TenantMaintenanceDetailsViewState();
}

class _TenantMaintenanceDetailsViewState extends ConsumerState<TenantMaintenanceDetailsView> {
  @override
  void initState() {
    super.initState();
    if (context.mounted) {
              ...
              child: Column(
                ...
                children: [
                  ...
                  ...{
                    ...
                    context.t.common.date: _data?.createdAt?.formatDate() ?? "N/A",
                    ...
                    if (_status == MaintenanceStatus.rejected) context.t.common.reason: _data?.notes ?? 'N/A',
                  }.entries.map(
                    (entry) {
                        ...
                        showCustomSnackBar(
                          ...
                          content: Text(
                            ...
                            context.t.exceptions.invalidApiDataRefreshPage(
                              dataType: context.t.common.maintenance.toLowerCase(),
                            ),
                          ),
