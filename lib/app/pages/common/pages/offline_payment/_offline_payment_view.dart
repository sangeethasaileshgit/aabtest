                ...
                children: [
                  ...
                  Builder(
                    builder: (_) {
                      ...
                      final _paymentMethods = [...?paymentMethods.valueOrNull?.data];
                        ...
                        child: DropdownButtonFormField<OfflinePaymentMethod>(
                            ...
                            ..._paymentMethods.map(
                              (method) {
                                return DropdownMenuItem(
                                  value: method,
                                  child: Text(
                                    method.manualData?.bankInfo?.bankName ?? "N/A",
                                  ),
                                );
                              },
                            ),
                          ...
                          validator: (value) {
                            if (value == null || (value.id ?? 0) <= 0) {
                              ...
                              return context.t.form.withdrawMethod.errors.required;
                            }
                      ...
                      child: Column(
                        ...
                        children: [
                          ...{
                            ...
                            // "Swift Code": "521364",
                            // "Branch": "johor",
                            context.t.pages.offlinePayment.extra.accountHolderName:
                                controller.selectedMethod?.manualData?.bankInfo?.accHolder ?? "N/A",
                            context.t.pages.offlinePayment.extra.accountNumber:
                                controller.selectedMethod?.manualData?.bankInfo?.accNumber ?? "N/A",
                  ...
                  TextFormField(
                    decoration: InputDecoration(
                      ...
                      labelText: context.t.form.note.label(
                        note: context.t.pages.offlinePayment.form.paymentNote.label,
                      ),
                      // hintText: 'Enter some text...',
                      hintText: context.t.form.note.hint(
                        note: context.t.pages.offlinePayment.form.paymentNote.hint,
                      ),
  ...
  Future<void> _handleFormSubmit(BuildContext ctx, WidgetRef ref) async {
    final _result = await showAsyncLoadingOverlay(
      ...
      asyncFunction: () => Future.microtask(
        () => ref
            .read(offlinePaymentViewProvider)
            .handleFormSubmit(
              invoiceId: invoiceId,
