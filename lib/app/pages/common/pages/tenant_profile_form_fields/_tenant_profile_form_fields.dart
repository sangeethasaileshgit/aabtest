    ...
    return Column(
      ...
      children: [
                ...
                TextSpan(
                  children: [
                    ...
                    TextSpan(
                      ...
                      recognizer: TapGestureRecognizer()..onTap = () => controller.handleTenantType(_type),
                    ),
                  ],
                ),
          ...
          TextFormField(
            ...
            validator: (value) {
              ...
              if (value.length < 6) {
                ...
                return context.t.form.password.errors.minLength(count: 6).sentenceCase;
              }
            ...
            Expanded(
              child: DateFormField(
                ...
                decoration: InputDecoration(
                  ...
                  labelText: context.t.form.date.label(label: context.t.common.dateOfBirth),
                  // hintText: 'Select date',
                  hintText: context.t.form.date.hint(label: context.t.common.dateOfBirth).sentenceCase,
          ...
          children: [
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                hintText: context.t.form.anyField.hint(label: context.t.common.nomineeName).sentenceCase,
              ),
            ),
            const SizedBox.square(dimension: 20),
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                hintText: context.t.form.anyField.hint(label: context.t.common.nomineeEmail).sentenceCase,
              ),
              validator: (value) {
                if (controller.nomineeEmailController.text.isEmpty) {
                  return null;
                }
            ...
            PhoneFormField(
              ...
              decoration: InputDecoration(
                ...
                hintText: context.t.form.anyField.hint(label: context.t.common.mobileNumber).sentenceCase,
              ),
        ...
        ExpansionTile(
          ...
          children: [
            ...
            DropdownButtonFormField<String?>(
              hint: Text(
                context.t.form.anyDropdown.hint(label: context.t.common.relation).sentenceCase,
              ),
              decoration: InputDecoration(
              ...
              initialValue: controller.ecSelectedRelation,
              isExpanded: true,
              items: [
                ...{
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                // labelText: 'Name',
                labelText: context.t.form.anyField.label(label: context.t.common.name),
                // hintText: 'Enter name',
                hintText: context.t.form.anyField.hint(label: context.t.common.name).sentenceCase,
              ),
            ),
            const SizedBox.square(dimension: 20),
            ...
            children: [
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: context.t.form.anyField.hint(label: context.t.common.companyName).sentenceCase,
                ),
              ),
              const SizedBox.square(dimension: 20),
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: context.t.form.anyField.hint(label: context.t.common.companySSMNo).sentenceCase,
                ),
              ),
            ],
          ),
          ...
          children: [
            ...
            _countryProvider.when(
              ...
              data: (data) {
                return DropdownButtonFormField<String?>(
                  ...
                  initialValue: controller.wSelectedCountry,
                  isExpanded: true,
                  items: [
                    ...data.map((country) {
                      return DropdownMenuItem(
            ...
            TextFormField(
              ...
              decoration: InputDecoration(
                ...
                labelText: context.t.form.anyField.label(label: context.t.common.officePhoneNo),
                // hintText: 'Enter office phone number',
                hintText: context.t.form.anyField.hint(label: context.t.common.officePhoneNo).sentenceCase,
              ),
            ),
            const SizedBox.square(dimension: 20),
            ...
            PhoneFormField(
              ...
              decoration: InputDecoration(
                ...
                hintText: context.t.form.anyField.hint(label: context.t.common.officeMobileNo).sentenceCase,
              ),
        ...
        ExpansionTile(
          ...
          title: Text(context.t.common.vehiclesInfo.optional, style: _cLabelStyle),
          tilePadding: EdgeInsetsDirectional.zero,
          childrenPadding: const EdgeInsetsDirectional.only(top: 12),
          children: [
            // Vehicle
        ...
        TextFormField(
          ...
          decoration: InputDecoration(
            ...
            labelText: context.t.form.anyField.label(label: context.t.common.nidPassportId),
            // hintText: 'Enter NID/Passport id number',
            hintText: context.t.form.anyField.hint(label: context.t.common.nidPassportId),
          ),
        ),
        const SizedBox.square(dimension: 8),
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownButtonFormField<String?>(
                ...
                hint: Text(
                  context.t.form.anyDropdown.label(label: context.t.common.vehiclesType).sentenceCase,
                ),
                decoration: InputDecoration(
                ...
                initialValue: controller.vehicleType,
                isExpanded: true,
                items: [
                  ...{
              ...
              TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  hintText: context.t.form.anyField.hint(label: context.t.common.vehicleBrand).sentenceCase,
                ),
                validator: (value) {
                  if (controller.isRequired) {
                    if (value == null || value.trim().isEmpty) {
                      // return "Please enter vehicle brand";
                      return context.t.form.anyField.errors.required(label: context.t.common.vehicleBrand).sentenceCase;
                    }
                  }
                  return null;
                },
