...
class ChatMessageItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return UnconstrainedBox(
      alignment: chatData.sendByUser ? AlignmentDirectional.centerEnd : AlignmentDirectional.centerStart,
            ...
            children: [
              ...
              Expanded(
                child: Column(
                  ...
                  crossAxisAlignment: chatData.sendByUser ? CrossAxisAlignment.start : CrossAxisAlignment.end,
                  children: [
                    // Attachment Only
                    ...
                    if (chatData.message != null) ...[
                      ChatBubble(
                        elevation: 0.35,
                        alignment: chatData.sendByUser ? Alignment.centerRight : Alignment.centerLeft,
                        clipper: ChatBubbleClipper5(
                          type: chatData.sendByUser ? BubbleType.sendBubble : BubbleType.receiverBubble,
                        ),
                        backGroundColor: chatData.sendByUser ? _theme.colorScheme.primary : const Color(0xffF7F7F7),
...
class ChatBubbleAttachment {
  ...
  ChatBubbleAttachment({
    ...
    String? ext,
    num? size,
  })  : type = ext != null ? FileFormFieldFileType.fromString(ext) : FileFormFieldFileType.fromFile(file?.local),
