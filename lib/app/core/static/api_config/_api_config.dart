...
abstract class DAPIEndpoints {
  ...
  static String dashboardPropertyChart = '$dashboardSummaryOverview/property-chart';
  static String dashboardAccountChart = '$dashboardSummaryOverview/account-chart';
  ...
  static String facilities([int? id]) => '/landlord/facilities${id != null ? '/$id' : ''}';
  static String amenities([int? id]) => '/landlord/amenities${id != null ? '/$id' : ''}';
  //------------Property Endpoints------------//
