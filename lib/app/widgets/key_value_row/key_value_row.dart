...
class KeyValueRow extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final _titleStyle =
        titleStyle ?? _theme.textTheme.bodyMedium?.copyWith(color: _theme.colorScheme.onPrimaryContainer);

    final _descriptionStyle = descriptionStyle ?? _titleStyle?.copyWith(color: _theme.colorScheme.secondary);
...
typedef KeyValueRowData = ({String label, String value});
