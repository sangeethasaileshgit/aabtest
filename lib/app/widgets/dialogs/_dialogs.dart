...
class PaymentTypeSelectorDialog extends StatefulWidget {
  ...
  @override
  State<PaymentTypeSelectorDialog> createState() => _PaymentTypeSelectorDialogState();
}
              ...
              child: ListView.separated(
                ...
                itemBuilder: (_, index) {
                  ...
                  return ListTile(
                    shape: RoundedRectangleBorder(
                      side: BorderSide(
                        color: isSelected
                            ...
                            : _theme.colorScheme.secondary.withValues(alpha: 0.15),
                        width: 1.25,
                      ),
                    ...
                    leading: Container(
                      constraints: BoxConstraints.tightFor(height: 34, width: 52),
