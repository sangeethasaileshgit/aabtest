              ...
              SizedBox.square(
                ...
                child: ClipRRect(
                  ...
                  child: UniversalImage(
                    data.userImage ?? DAppImages.emptyImagePlaceholder,
                    fit: BoxFit.cover,
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                          ...
                          child: RatingBarIndicator(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return index < data.rating.floor()
                                  ? _rating.full
                                  : (index == data.rating.floor() && data.rating % 1 != 0
                                        ? _rating.half
                                        : _rating.empty);
                            },
                          ),
                        ...
                        // Review Date
                        Text(
                          data.date == null ? 'N/A' : intl.DateFormat('dd MMM, yyyy').format(data.date!),
...
class ReviewCardData {
  ...
  factory ReviewCardData.mock([int randomness = 0]) {
    return ReviewCardData(
      userImage: "https://picsum.photos/400/250?random=$randomness",
      userName: 'John Doe',
      date: DateTime.now().subtract(const Duration(days: 3)),
      rating: 3.5,
      description: 'Iusto veritatis sed ipsum quaerat quisquam ducimus natus.',
    );
  }
}
