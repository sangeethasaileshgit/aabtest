...
class AcnooDateFilterDropdown extends StatefulWidget {
  ...
  const AcnooDateFilterDropdown.formField({
    super.key,
    this.items,
    this.value,
    this.replaceDefault = false,
  ...
  @override
  State<AcnooDateFilterDropdown> createState() => AcnooDateFilterDropdownState();
  ...
  static void setCustomDateRange({
    ...
    if (state == null) {
      throw Exception('AcnooDateFilterDropdown state is not available.');
    }
...
class AcnooDateFilterDropdownState extends State<AcnooDateFilterDropdown> {
  ...
  void _updateDropdownItems() {
    final newItems = [
      if (!widget.replaceDefault) ...AcnooDateFilterDropdown.defaultDropdownItems,
      ...?widget.items,
  ...
  Widget build(BuildContext context) {
    ...
    final _theme = Theme.of(context);
    final _buttonDecoration = widget.decoration ?? AcnooDateFilterDropdown.defaultDecoration(context);
      ...
      builder: (context, child) {
        ...
        return DatePickerTheme(
          data: DatePickerThemeData(
            ...
            rangeSelectionBackgroundColor: _theme.colorScheme.primary.withValues(alpha: 0.25),
          ),
          child: child!,
        );
      },
