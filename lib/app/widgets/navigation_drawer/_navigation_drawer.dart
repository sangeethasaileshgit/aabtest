            ...
            ColoredBox(
              ...
              child: ListTile(
                ...
                leading: SizedBox.square(
                  dimension: 40,
                  child: Image.asset(DAppImages.signInLogoIcon),
                ),
            ...
            Flexible(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final _isActive = _entry.bottomNavIndex == bottomNavActiveIndex;
      ...
      child: ListTile(
        ...
        leading: SizedBox.square(
          ...
          child: tile.icon == null
              ...
              : UniversalImage(
                  tile.icon,
                  color: isActive ? _theme.colorScheme.primary : _theme.colorScheme.secondary,
                  size: 20,
                ),
        ),
