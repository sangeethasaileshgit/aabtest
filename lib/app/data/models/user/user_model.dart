...
class User extends Equatable {
  ...
  factory User.fromJson(Map<String, dynamic> json) {
    return User(
      ...
      role: json["role"],
      email: json["email"],
      image: json['image'] != null ? DynamicFileType(remote: json['image']) : null,
      ...
      systemCurrency: json["currency"]?["symbol"],
      willExpireAt: json["will_expire"] == null ? null : DateTime.parse(json["will_expire"]),
    );
  }
  ...
  Map<String, dynamic> toRequest() {
    return {
      ...
      // Emergency Contact
      "emergency_contact[relation_with]": userDetails?.emergencyContact?.relationWith,
      "emergency_contact[name]": userDetails?.emergencyContact?.name,
      "emergency_contact[mobile_no]": userDetails?.emergencyContact?.phone?.mobileNo,
      "emergency_contact[mobile_code]": userDetails?.emergencyContact?.phone?.mobileCode,
...
class Phone {
  ...
  Phone({this.mobileNo, this.mobileCode});
...
class UserDetails {
  ...
  factory UserDetails.fromJson(Map<String, dynamic> json) {
    return UserDetails(
      ...
      nomineeInfo: json["nominee_info"] == null ? null : EmergencyContact.fromJson(json["nominee_info"]),
      emergencyContact: json["emergency_contact"] == null ? null : EmergencyContact.fromJson(json["emergency_contact"]),
      workplace: json["workplace"] == null ? null : Workplace.fromJson(json["workplace"]),
      vehiclesInfo: json["vehicles_info"] == null
          ? []
          : List<VehiclesInfo>.from(json["vehicles_info"]!.map((x) => VehiclesInfo.fromJson(x))),
      createdAt: json["created_at"] == null ? null : DateTime.parse(json["created_at"]),
      updatedAt: json["updated_at"] == null ? null : DateTime.parse(json["updated_at"]),
    );
  }
...
class EmergencyContact {
  ...
  factory EmergencyContact.fromJson(Map<String, dynamic> json) {
    return EmergencyContact(
      ...
      name: json["name"],
      email: json["email"],
      phone: [json["mobile_code"], json["mobile_no"]].any((element) => element != null)
          ? Phone(
              mobileCode: json["mobile_code"],
              mobileNo: json["mobile_no"],
            )
