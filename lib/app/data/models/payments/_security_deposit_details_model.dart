...
class SecurityDepositDetailsModel {
  ...
  factory SecurityDepositDetailsModel.fromJson(Map<String, dynamic> json) => SecurityDepositDetailsModel(
    message: json["message"],
    data: json["data"] == null ? null : SecurityDepositDetails.fromJson(json["data"]),
  );
}
