...
class RentDetails extends Equatable {
  ...
  static PropertyModel? _mergeProperty(Map<String, dynamic> json) {
    ...
    return PropertyModel.fromJson(_newJson).copyWith(
      ...
      stepFourData: UnitRentPricingStepModel.fromJson(_newJson),
    );
  }
  ...
  @override
  List<Object?> get props => [id, propertyId, unitId];
}
...
class CancelInfo {
  ...
  factory CancelInfo.fromJson(Map<String, dynamic> json) => CancelInfo(
    title: json["title"],
    reason: json["reason"],
    prevEndDate: json["prev_end_date"] == null ? null : DateTime.parse(json["prev_end_date"]),
  );
}
