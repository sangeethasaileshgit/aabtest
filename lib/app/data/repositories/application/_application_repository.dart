...
class ApplicationRepository {
  ...
  //--------------------------Manage Application--------------------------//
  Future<ApplicationDetailsModel> manageApplication(Application data) async {
    ...
    try {
      final _response = await dioClient.post(
        data.id != null ? DAPIEndpoints.application(data.id!) : DAPIEndpoints.applications,
        options: DioOptions(headers: _httpClient.getAuthHeader),
        data: _formData,
      );
...
final applicationDetailsProvider = FutureProvider.autoDispose.family<ApplicationDetailsModel, int>(
